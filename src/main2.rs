...
fn main() {
    // prev arguments;
    // r1cs_bytes: Vec<u8>, -> go back to old path input
    // wasm_bytes: Vec<u8>, -> go back to old path input
    // frogs_js: JsValue, -> go back to old path input
    ...
    println!("{}", "created external_inputs!");
    ...
    println!("{}", "successfully serialized nova params");
    ...
    println!("{}", "successfully serialized groth16 params");
    ...
    println!("generated decider_vp: {:?}", decider_vp); // print to check it's same as when running main.rs (to serialize params)
    ...
    println!("{}", "generated decider proof!");
