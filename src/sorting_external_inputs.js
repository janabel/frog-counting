...
async function add_frogMessageHash(parsedFrog) {
  parsedFrogObj = JSON.parse(parsedFrog);
  console.log(parsedFrogObj);
}

const parsedFrog = require("parsedfrog.json");
add_frogMessageHash(parsedFrog);
